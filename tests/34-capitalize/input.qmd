...
\acr[capitalise=true]{mRNA} is capitalized when the long name is at the beginning of a sentence.

\acr[capitalize=true]{mRNA} is not capitalized when the short name is used.
